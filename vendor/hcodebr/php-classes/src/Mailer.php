...
class Mailer{
	...
	const USERNAME = "leandro26sf@gmail.com";
	const PASSWORD = "Leafon2020";
	const NAME_FROM = "WSink";
	...
	{ 
		...
		$config = array(
			"tpl_dir"       => $_SERVER["DOCUMENT_ROOT"] . "/views/email/",       		// Local onde é armazenado os templates
